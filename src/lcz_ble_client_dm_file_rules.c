/**
 * @file lcz_ble_client_dm_file_rules.c
...
LOG_MODULE_REGISTER(lcz_ble_client_dm_file_rules, CONFIG_LCZ_BLE_CLIENT_DM_LOG_LEVEL);
...
#if defined(CONFIG_LCZ_FS_MGMT_FILE_ACCESS_HOOK)
	lcz_fs_mgmt_register_evt_cb(client_dm_file_test);
#endif
#if defined(CONFIG_LCZ_LWM2M_FS_MANAGEMENT)
	lcz_lwm2m_obj_fs_mgmt_reg_perm_cb(client_dm_file_test);
