...
/**************************************************************************************************/
#ifdef CONFIG_LCZ_BLE_CLIENT_DM_MEMFAULT
#define LCZ_BLE_CLIENT_DM_MEMFAULT_POST_DATA lcz_ble_client_dm_memfault_post_data
#else
#define LCZ_BLE_CLIENT_DM_MEMFAULT_POST_DATA(...)
#endif
...
#endif /* CONFIG_LCZ_BLE_CLIENT_DM_MEMFAULT*/
